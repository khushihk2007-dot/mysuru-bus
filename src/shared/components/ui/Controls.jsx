...
// Slider Component (HTML5 range wrapper with clean design styling)
export const Slider = React.forwardRef(
  ({ className, label, min = 0, max = 100, step = 1, value, onChange, disabled, ...props }, ref) => {
        ...
        <div className="relative flex w-full items-center select-none">
          <input
            ...
            className={cn(
              ...
              // Range slider thumb customization
